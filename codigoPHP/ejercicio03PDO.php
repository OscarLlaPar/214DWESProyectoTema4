...
<html>
    ...
    <body>
        <?php
            ...
            */
            ...
            if(!empty($_REQUEST['enviar'])){
                ...
                $aErrores['descripcion']= validacionFormularios::comprobarAlfabetico($_REQUEST['descripcion'],50,3,1);
        ...
        ?>              
                                    ...
                                    <input id="descripcion" type="text" name="codigo" value="<?php echo (isset($_REQUEST['descripcion']))?$_REQUEST['descripcion']:"";?>" >
